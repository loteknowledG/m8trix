import { Box, Button, Dialog, Drawer, IconButton, SvgIcon, Toolbar, Typography  } from '@mui/material'
...
export default function TopAppBar() {
  ...
  return (<Box sx={{ flexGrow: 1 }}>
    <GlassAppBar position="static" justify="space-between">
      <Toolbar>
        <Button size="large" aria-label="back" onClick={()=>{history.push('/')}} >
